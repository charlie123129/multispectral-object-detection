...
from utils.torch_utils import EarlyStopping, ModelEMA, select_device, intersect_dicts, torch_distributed_zero_first, is_parallel
...
def train(hyp, opt, device, tb_writer=None):
    ...
    # Process 0
    if rank in [-1, 0]:
        testloader = create_dataloader_rgb_ir(test_path_rgb, test_path_ir, imgsz_test, batch_size * 2, gs, opt,  # testloader
