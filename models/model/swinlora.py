...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.SiLU, drop=0.,rank=32,h=1):
        super().__init__()
...
class C3SLORA(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        c_ = int(c2 * e)  # Calculate hidden layer channels based on expansion factor
        num_heads = max(c_ // 32, 1)  # Compute the number of heads for the transformer, ensuring at least 1 head.
