...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF,DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP,
                 C3, C3TR, C2f,C3STR,C3SLORA,SWIN,SWINLORA,C3SV2TR,
                 nn.ConvTranspose2d,CARAFE,C3lora,LoRAConv2d,
            ...
            if m is Focus:
                ...
                args = [c1, c2, *args[1:]]
                if m in [BottleneckCSP, C3, C3TR,C3STR,C3SLORA,SWIN,SWINLORA,C3SV2TR,C2f,VoVGSCSP,C3lora]:
        ...
        elif m is SHARED_GPT:
            c2 = ch[f[0]]
            args = [c2]

        elif m is SHARED_GPT_LORA:
            c2 = ch[f[0]]
            args = [c2]
...
if __name__ == '__main__':
    ...
    traced_model = torch.jit.trace(model, (input_rgb, input_ir))
    # 保存跟踪後的模型
    torch.jit.save(traced_model, "yololook_traced.pt")
    print("Model tracing complete and saved.")
    print("YOLO")
