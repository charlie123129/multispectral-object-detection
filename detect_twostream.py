...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/sherry/charlie/multispectral/runs/train/exp/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/home/sherry/charlie/dataset/LLVIP/LLVIP1020/trainnomove_test20/visible/test', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/sherry/charlie/dataset/LLVIP/LLVIP1020/trainnomove_test20/visible/test', help='source')  # file/folder, 0 for webcam
